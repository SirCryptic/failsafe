...
files = [
    "file1.jpg",  # Change this to the path of your first file
    "file2.pdf",  # Change this to the path of your second file
    "file3.txt",  # Change this to the path of your third file
    "file4.mp3",  # Change this to the path of your fourth file
    "file5.mp4",  # Change this to the path of your fifth file
    "file6.docx", # Change this to the path of your sixth file
    # Add more files here
]
while True:
